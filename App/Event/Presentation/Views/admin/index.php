...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500">Overview and administration of university events.</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div
            ...
            <div>
                ...
                <p class="text-xl font-bold text-slate-800"><?= $statistics['total_events'] ?? 0 ?></p>
                <p class="text-[11px] text-slate-400">All events</p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-xl font-bold text-slate-800"><?= $statistics['published_events'] ?? 0 ?></p>
                <p class="text-[11px] text-slate-400">Active events</p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                <p class="text-[11px] uppercase tracking-wide text-slate-400 font-medium">Upcoming</p>
                <p class="text-xl font-bold text-slate-800"><?= $statistics['upcoming_events'] ?? 0 ?></p>
                <p class="text-[11px] text-slate-400">Future schedules</p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                <p class="text-[11px] uppercase tracking-wide text-slate-400 font-medium">Completed</p>
                <p class="text-xl font-bold text-slate-800"><?= $statistics['completed_events'] ?? 0 ?></p>
                <p class="text-[11px] text-slate-400">Finished events</p>
            </div>
        </div>
    </div>
            ...
            <table class="w-full text-sm text-slate-700">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-5 py-3.5 text-left">Venue</th>
                        <th class="px-5 py-3.5 text-left">Capacity</th>
...
<?php
/**
 * Build event pagination URL with current filters
 */
function buildEventPaginationUrl(int $page, array $query): string
{
    $query['page'] = $page;
    $query = array_filter($query, function ($value) {
        return $value !== '' && $value !== null;
    });
    return BASE_URL . '/admin/events?' . http_build_query($query);
}
?>
