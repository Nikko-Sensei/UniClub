...
*/
    ...
    */
    ...
    | 2026-08-18 23:59:00
    |
    | Do NOT append another time because your database already
    | stores the complete datetime.
    |
    */

            $registrationDeadline = strtotime(
                $event->getRegistrationDeadline()
            );

            $isRegistrationClosed = $now > $registrationDeadline;
    ...
    */
    ...
    ">
         ...
         ========================================================== -->
                ...
                <button type="button" onclick="openRegisterModal()" class="
            inline-flex
            items-center
            gap-2
            px-6
